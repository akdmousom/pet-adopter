        ...
        <>
            <div className="max-w-[1366px] mx-auto bg-[#FFF5E4]">
                <div className="carousel-item relative w-full">
                    <Image src="https://i.ibb.co/MBNhPW4/pet-1.jpg" width={1900} height={600} alt="Pet Banner" className="w-screen lg:w-[1366px] h-[400px] lg:h-screen" />
                ...
                <div className="flex flex-col lg:flex-row items-center space-y-4 justify-around w-full my-8 px-4">
                    ...
                    <div>
                        <Image src="https://i.ibb.co/ZT5KN77/pet-5.jpg" width={1900} height={600} alt="pet-5" className=" rounded-3xl px-3 " />
                    </div>
                </div>
                ...
                <div className="mb-20 lg:mb-40 px-4">
                    ...
                    <div className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-0 justify-between">
                        <Image src="https://i.ibb.co/PrT58Qp/F1-Formula-1.png" width={1900} height={600} alt="F1-Formula-1" className="hover:scale-110 hover:border-black border-2 transfrom duration-700 w-[300px] h-[300px] object-cover" />
                        <Image src="https://i.ibb.co/3yn4PhJ/Louis-Vuitton-Print.png" width={1900} height={600} alt="Louis Vuitton" className="hover:scale-110 hover:border-black border-2 transfrom duration-700 w-[300px] h-[300px] object-cover" />
                        <Image src="https://i.ibb.co/D7R6575/STANLEY.png" width={1900} height={600} alt="STANLEY" className="hover:scale-110 hover:border-black border-2 transfrom duration-700 w-[300px] h-[300px] object-cover" />
                ...
                <div className="bg-[#ffe3e1] mb-8 py-4 px-3">
                    <div className="flex flex-1 flex-col lg:flex-row lg:grid-cols-3 gap-6 lg:gap-0 items-center justify-between">
                        ...
                        <div className="lg:px-3 space-y-4 col-span-5">
