...
const Googlemap = () => {
  ...
  return (
    <div className="mx-5 lg:mx-24 py-10">
      <div className="bg-[#FFF5E4] dark:bg-[#AD8155] text-3xl lg:text-4xl text-center dark:text-white font-bold py-6 px-4 mb-8">Local Address</div>
      <Map height={300} dprs={[1, 2]} defaultCenter={anchor} defaultZoom={11} className='h-44 bg-[#FFF5E4] p-24 dark:bg-[#AD8155]'>
