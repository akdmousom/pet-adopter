                    ...
                    <form onSubmit={handleEdit} className="space-y-4">
                        ...
                        <div className="flex md:flex-row flex-col gap-5">
                            ...
                            <label className="form-control w-full">
                                ...
                                <input type="text" name="name1" required placeholder="First Name" id="" className="p-1 border-2 " />
                            </label>
                            {/* Last Name  */}
                            <label className="form-control w-full">
                                <span className="label-text-alt font-medium text-lg">Last Name</span>
                                <input type="text" name="name2" required placeholder="Last Name" id="" className="p-1 border-2 " />
                            </label>
                        </div>
                        {/* Email */}
                        <label className="form-control w-full">
                            <span className="label-text-alt font-medium text-lg">Email</span>
                            <input type="email" name="email" required placeholder="Email" id="" className="p-1 border-2" />

                        </label>
                        {/* Address */}
                        <label className="form-control w-full">
                            <span className="label-text-alt font-medium text-lg">Address</span>
                            <input type="text" name="address" required placeholder="Address" id="" className="p-1 border-2" />
                        </label>
                        {/* Contact Number */}
                        <label className="form-control w-full">
                            <span className="label-text-alt font-medium text-lg">Contact Number</span>
                            <input type="number" name="contact" required placeholder="Contact Number" id="" className="p-1 border-2" />
                        </label>
                        ...
                        <div className="flex md:flex-row flex-col gap-5">
                            ...
                            <label className="form-control w-full">
                                ...
                                <input type="text" name="city" required placeholder="City" id="" className="p-1 border-2 " />
                            </label>
                            {/* State */}
                            <label className="form-control w-full">
                                <span className="label-text-alt font-medium text-lg">State</span>
                                <input type="text" name="state" required placeholder="State" id="" className="p-1 border-2 " />
                            </label>
                        </div>
                        {/* Password */}
                        <label className="form-control w-full">
                            <span className="label-text-alt font-medium text-lg">Password</span>
                            <input type="password" name="password" required placeholder="Password" id="" className="p-1 border-2" />
                        </label>
