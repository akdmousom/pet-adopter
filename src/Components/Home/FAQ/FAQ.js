    ...
    return (
        <>
            <div className='pt-8 pb-16'>
                ...
                <div className='flex flex-col lg:flex-row items-center justify-center gap-3 py-8 px-4 mx-auto'>
                    <div className='w-1/2 mx-auto'>
                        <Image src="https://i.ibb.co/hKdxMdP/pet-6.jpg" alt="pet-6" width={400} height={400} className='hidden md:block rounded-md w-[400px] md:w-[400px] lg:w-[600px] mx-auto h-[200px] md:h-[400px] lg:h-[400px] object-cover' />
                    </div>
                    <div className='w-1/2 mx-auto'>
                        <div className="collapse collapse-arrow bg-white dark:bg-pink-100 border-2 border-black mb-4 w-3/4">
