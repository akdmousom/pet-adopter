...
const page = () => {
    ...
    return (
         <div className="my-5 max-w-[1280px] mx-auto">
            ...
            <div className="bg-base-100 shadow-xl p-5 md:p-8">
                ...
                <div className="w-2/3 mx-auto my-8">
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-8">
                        ...
                        <h2 className="md:text-lg">Gender</h2>
                ...
                <div className="w-2/3 mx-auto my-8">
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-8">
                        ...
                        <h2 className="md:text-lg">Phone</h2>
                ...
                <div className="w-2/3 mx-auto my-8">
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-8">
                        <h2 className="md:text-base">Home</h2>
                        <h1 className="md:text-base font-medium">Not Set</h1>

                        <h2 className="md:text-base">Work</h2>
                        <h1 className="md:text-base font-medium">Not Set</h1>

                        <h2 className="md:text-base">Other Addresses</h2>
